...
const ServiceCard = ({ imageUrl, title, description, link }) => {
  return (
    <Link to={link} className="w-full sm:w-1/2 md:w-1/4 lg:w-1/4 xl:w-1/4 rounded overflow-hidden mx-4 my-8 transform hover:scale-105 transition duration-300 ease-in-out">
    ...
    <div className="container mx-auto">
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <ServiceCard
          ...
          title="Safe Housing and Community Support"
        ...
        <ServiceCard
          ...
          title="Collaborative Multi-Agency Approach"
