...
const WhoWeAre = () => {
  return (
    <div className="container mx-auto py-10 px-4 sm:px-6 lg:py-20 lg:px-8 border-t border-b border-blue-950 ">
      <div className="flex flex-col md:flex-row rounded-lg overflow-hidden mt-4 animate-fade-in-up">
        <div className="p-6 md:w-1/3">
          <h2 className="text-3xl font-semibold text-blue-950 font-[Open Sans] mb-4">Key components of prevention efforts</h2>
